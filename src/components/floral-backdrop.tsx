...
const DEFAULT_FRIENDS: Friend[] = [
  { id: "b1",  kind: "honey",    px: 6,  py: 14, size: 84, rotation: -8 },
  { id: "b2",  kind: "lavender", px: 92, py: 10, size: 88, rotation: 10 },
  { id: "b3",  kind: "sage",     px: 18, py: 28, size: 76, rotation: 5 },
  { id: "b4",  kind: "cream",    px: 88, py: 26, size: 80, rotation: -6 },
  { id: "b5",  kind: "skyblue",  px: 4,  py: 44, size: 82, rotation: 12 },
  { id: "b6",  kind: "rose",     px: 95, py: 42, size: 78, rotation: -10 },
  { id: "b7",  kind: "honey",    px: 22, py: 60, size: 72, rotation: 8 },
  { id: "b8",  kind: "lavender", px: 86, py: 58, size: 86, rotation: -5 },
  { id: "b9",  kind: "sage",     px: 6,  py: 72, size: 78, rotation: -12 },
  { id: "b10", kind: "cream",    px: 94, py: 74, size: 76, rotation: 8 },
  { id: "b11", kind: "skyblue",  px: 26, py: 86, size: 80, rotation: 6 },
  { id: "b12", kind: "rose",     px: 76, py: 88, size: 82, rotation: -8 },
  { id: "b13", kind: "honey",    px: 50, py: 6,  size: 62, rotation: -4 },
  { id: "b14", kind: "sage",     px: 48, py: 94, size: 64, rotation: 10 },
  { id: "b15", kind: "lavender", px: 12, py: 90, size: 60, rotation: -15 },
  { id: "b16", kind: "cream",    px: 90, py: 88, size: 58, rotation: 12 },
  { id: "b17", kind: "rose",     px: 60, py: 38, size: 56, rotation: 7 },
  { id: "b18", kind: "skyblue",  px: 38, py: 50, size: 58, rotation: -6 },
];
